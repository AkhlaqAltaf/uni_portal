...
const AdminInfo = () => {
    ...
    return (
        <div className="p-6 bg-[#193344] rounded-xl shadow-lg border-2 border-[#087c4e]">
            <div className="flex flex-col md:flex-row gap-6">
                ...
                {/* Profile Information */}
                <div className="md:w-3/4 bg-[#193344]  rounded-xl shadow-md p-6 border-2 border-[#087c4e]">
...
const InfoItem = ({ icon, label, value }) => (
    <div className="flex items-center p-2 hover:bg-[#048c51] rounded-lg  transition-colors duration-200">
