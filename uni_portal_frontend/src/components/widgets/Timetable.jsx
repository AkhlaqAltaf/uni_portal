      ...
      slots: [
        {
          ...
          teacher: "Dr. Ghulam Mujtaba",
        },
        {
          time: "10:40 To 12:10",
          location: "C205 (50M)",
          course: "Compiler Construction",
          teacher: "Faryal Jahangir",
        },
      ],
    },
    {
  ...
  return (
    <div className="p-6">
      ...
      <table className="min-w-full border-collapse border border-gray-300 text-sm">
        <thead>
          <tr>
            <th className="border border-gray-300 bg-gray-100 p-2 font-bold text-center w-1/6">
              Day
            </th>
            {timeSlots.map((time, index) => (
              <th
                key={index}
                className="border border-gray-300 bg-gray-100 p-2 font-bold text-center w-1/6"
              >
                {time}
              </th>
            ))}
